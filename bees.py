...
def print_details(cycle, path, distance):
...
def main():
    ...
    data = read_data_from_csv("data/data_15.csv")
    ...
    while cycle < cycle_limit:
        ...
        if waggle_distance < best_distance:
            ...
            print_details(cycle, best_path, best_distance)
            result = (cycle, best_path, best_distance)
